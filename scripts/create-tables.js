...
if (!module.parent) {
  createTables().then(() => {
    logger.info('Done! The index creation might still take some time. Please check the Dynamodb interface to verify that all processes have indeed completed and you are good to proceed with the next step')
    process.exit()
  }).catch((e) => {
